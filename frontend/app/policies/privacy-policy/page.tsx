  ...
  return (
    <div className="bg-white text-black">
      <div className="max-w-xs md:max-w-xl mx-auto pt-28">
        <h1 className="text-5xl md:text-6xl text-center pt-10 font-semibold">Privacy policy</h1>
      </div>

      <div className="text-sm tracking-wider">
        <div className="max-w-xs md:max-w-xl mx-auto pt-4">
          <div>
            <p className="py-4">Last updated: April 13, 2026</p>
            <p>
              Tile Bazaar operates this store and website, including all related
              information, content, features, tools, products and services, in
              order to provide you, the customer, with a curated shopping
              experience (the &quot;Services&quot;). This Privacy Policy
            ...
            <br />
            <h2 className="text-4xl py-4 font-semibold">Personal Information <br /> We Collect or Process</h2>
            <p>
              ...
              another person. Personal information does not include information
              that is collected anonymously or that has been de-identified, so
              that it cannot identify or be reasonably linked to you. We may
              collect or process the following categories of personal
              information, including inferences drawn from this personal
              information, depending on how you interact with the Services,
            ...
            <ul className="list-disc ml-4">
              ...
              <li>
                ...
                view, put in your cart, add to your wishlist, or purchase,
                return, exchange or cancel and your past transactions.
              </li>
              <li>
                <strong>Communications with us</strong> including the
                information you include in communications with us, for example,
                when sending a customer support inquiry.
              </li>
              <li>
                <strong>Device information</strong> including information about
                your device, browser, or network connection, your IP address,
                and other unique identifiers.
              </li>
              <li>
                <strong>Usage information</strong> including information
                regarding your interaction with the Services, including how and
                when you interact with or navigate the Services.{" "}
              </li>
            </ul>
            <br />
            <h2 className="text-4xl py-4 font-semibold">Personal Information Sources</h2>
            <p>
            ...
            <ul className="list-disc ml-4">
              ...
              <li>
                ...
                from your device when you use our products or services or visit
                our websites, and through the use of cookies and similar
                technologies;
              </li>
              <li>
            ...
            <br />
            <h2 className="text-4xl py-4 font-semibold">How We Use Your Personal Information</h2>
            <p>
            ...
            <ul className="list-disc ml-4">
              <li>
                ...
                use your personal information to provide you with the Services,
                including to perform our contract with you, to process your
                payments, to fulfill your orders, to remember your preferences
                and items you are interested in, to send notifications to you
                related to your account, to process purchases, returns,
                exchanges or other transactions, to create, maintain and
                otherwise manage your account, to arrange for shipping, to
                facilitate any returns and exchanges, to enable you to post
                reviews, and to create a customized shopping experience for you,
                such as recommending products related to your purchases. This
                may include using your personal information to better tailor and
              ...
              <li>
                ...
                email, text message or postal mail, and to show you online
                advertisements for products or services on the Services or other
                websites, including based on items you previously have purchased
                or added to your cart and other activity on the Services.{" "}
              </li>
              <li>
                <strong>Security and Fraud Prevention.</strong> We use your
                personal information to authenticate your account, to provide a
                secure payment and shopping experience, detect, investigate or
                take action regarding possible fraudulent, illegal, unsafe, or
                malicious activity, protect public safety, and to secure our
                services. If you choose to use the Services and register an
              ...
              <li>
                <strong>Legal Reasons.</strong> We use your personal information
                ...
                to investigate or participate in civil discovery, potential or
                actual litigation, or other adversarial legal proceedings, and
                to enforce or investigate potential violations of our terms or
                policies.
              </li>
            </ul>
            <br />
            <h2 className="text-4xl py-4 font-semibold">How We Disclose Personal Information</h2>
            <p>
            ...
            <ul className="list-disc ml-4">
              <li>
                With [marketing tool name], vendors and other third parties who perform
                services on our behalf (e.g. IT management, payment processing,
                data analytics, customer support, cloud storage, fulfillment and
                shipping).
              </li>
              <li>
                With business and marketing partners to provide marketing
                services and advertise to you. For example, we use [marketing tool name] to
                support personalized advertising with third-party services based
                ...
                accordance with their own privacy notices. Depending on where
                you reside, you may have a right to direct us not to share
                information about you to show you targeted advertisements and
                marketing based on your online activity with different merchants
                and websites.
              </li>
              <li>
              ...
              <li>
                ...
                policies, and to protect or defend the Services, our rights, and
                the rights of our users or others.
              </li>
            </ul>
            <br />
            {/* <h2 className="text-5xl py-4 font-semibold">Relationship with Shopify</h2>
            <p>
              ...
              with respect to your personal information here{" "}
              <a href="https://privacy.shopify.com/en">
                Shopify Privacy Portal Link
              </a>
              .{" "}
            </p>
            <br /> */}
            <h2 className="text-4xl py-4 font-semibold">Third Party Websites <br /> and Links</h2>
            <p>
            ...
            <h2 className="text-4xl py-4 font-semibold">Security and Retention of Your Information</h2>
            <p>
            ...
            <br />
            <h2 className="text-4xl py-4 font-semibold">Your Rights and <br />Choices</h2>
            <p>
            ...
            <div>
              <p>
                <strong>
                  If you reside in the UK or European Economic Area,
                </strong>{" "}
                and subject to exceptions and limitations provided by local law,
                you may exercise the following rights in addition to the rights
                outlined above:
              </p>
              <br />
              <ul className="list-disc ml-4">
                ...
                <li>
                  ...
                  right to withdraw this consent. If you withdraw your consent,
            ...
            <br />
            <h2 className="text-4xl py-4 font-semibold">Complaints</h2>
            <p>
              ...
              authority. For the EEA, you can find a list of the responsible
              data protection supervisory authorities{" "}
              <a href="https://edpb.europa.eu/about-edpb/about-edpb/members">
                here
              </a>
              .
            </p>
            <br />
            <h2 className="text-4xl py-4 font-semibold">International Transfers</h2>
            <p>
            ...
            <br />
            <h2 className="text-4xl py-4 font-semibold">Changes to This <br /> Privacy Policy</h2>
            <p>
              ...
              this website, update the &quot;Last updated&quot; date and provide notice as
              required by applicable law.
            </p>
            <br />
            <h2 className="text-4xl py-4 font-semibold">Contact</h2>
            <p>
              ...
              available to you, please call or email us at info@tilebazaar.co.uk
              or contact us at Unit 10 Slough Interchange Industrial Estate, Whittenham Close, Slough, SL2 5EP
