...
//   if (loading) return <div className="p-10 text-center font-bold">Loading User...</div>;
...
//               </div>
//               <div>
//                 <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest">User Since</p>
...
//                   <p className="text-center py-10 text-gray-400 font-medium">No orders found for this user.</p>
//                 )}
//               </div>
//             </div>
//           </div>
...
const stats = useMemo(() => {
  ...
  if (loading) return <div className="p-10 text-center text-gray-500 font-medium animate-pulse">Loading User Profile...</div>;
